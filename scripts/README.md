...
| Script | Purpose |
|---|---|
| `bootstrap.sh` | Provision a fresh Ubuntu arm64 box into the services server (step 2 of `docs/new-box-bootstrap.md`). Idempotent; stops for real env values on first run. |
